...
while cap.isOpened():
    ...
    line_pos += line_step
    cv2.line(frame,(line_pos,0),(line_pos,H),(247,233,128),line_thick)
    cv2.line(final_display_frame,(line_pos,0),(line_pos,H),(247,233,128),line_thick)
    ...
    if line_pos == int(W/line_step)*line_step:
        break
    if cv2.waitKey(1) == 27:
        break
